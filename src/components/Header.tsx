...
export function Header() {
  ...
  return (
    <HeaderContainer>
      ...
      <Animate onChange={entry => { handleChangeAnimation({ entry, entryAnimationName: 'animate__fadeInDown', exitAnimationName: 'animate__fadeOutUp', animationDelayName: 'animate__faster' }) }}>
        <nav>

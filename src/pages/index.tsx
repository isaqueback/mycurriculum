...
export default function Home() {
  ...
  return (
    <HomeContainer>
      <Presentation1>
        <div>
          <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__zoomInLeft', exitAnimationName: 'animate__zoomOutLeft', animationDelayName: 'animate__faster' })}>
            <h2>Faça seu currículo agora com modelos prontos</h2>
          </Animate>
          <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__fadeInLeft', exitAnimationName: 'animate__fadeOutLeft', animationDelayName: 'animate__faster' })}>
            <p >
              Com um currículo bem elaborado, você aumenta suas chances de
              conseguir a vaga dos seus sonhos!
            </p>
          </Animate>
          <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__bounceIn', exitAnimationName: 'animate__bounceOut', animationDelayName: 'animate__faster' })}>
            <Link href="/">
        ...
        <div>
          <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__fadeInDown', exitAnimationName: 'animate__fadeOutDown', animationDelayName: 'animate__faster' })}>
        ...
        <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__fadeInUp', exitAnimationName: 'animate__fadeOutUp', animationDelayName: 'animate__faster' })}>
          <Link href="/">
            <button>Fazer currículo</button>
          </Link>
        </Animate>
      ...
      <Presentation2>
        ...
        <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__lightSpeedInLeft', exitAnimationName: 'animate__lightSpeedOutLeft', animationDelayName: 'animate__faster' })}>
          <Image
        ...
        <article>
          <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__lightSpeedInRight', exitAnimationName: 'animate__lightSpeedOutRight', animationDelayName: 'animate__faster' })}>
            <section>
      ...
      <Presentation3>
        <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__zoomIn', exitAnimationName: 'animate__zoomOut', animationDelayName: 'animate__faster' })}>
          <h2>Alguns de nossos modelos</h2>
        </Animate>
        <Carousel />
        <Animate onChange={entry => handleChangeAnimation({ entry, entryAnimationName: 'animate__fadeInRight', exitAnimationName: 'animate__fadeOutLeft', animationDelayName: 'animate__faster' })}>
          <Link href="/">
